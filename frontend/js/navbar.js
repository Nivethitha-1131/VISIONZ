(function () {
  ...
  .vz-nav{position:sticky;top:0;z-index:999;background:rgba(9,14,27,.97);
    backdrop-filter:blur(20px);-webkit-backdrop-filter:blur(20px);
    border-bottom:1px solid rgba(56,189,248,.12);box-shadow:0 2px 24px rgba(0,0,0,.5);}
  ...
  .vz-brand-ico{width:36px;height:36px;background:linear-gradient(135deg,rgba(56,189,248,.18),rgba(129,140,248,.12));
  ...
  .vz-links a{display:flex;align-items:center;gap:6px;padding:.42rem .9rem;border-radius:9px;
    font-size:.81rem;font-weight:600;color:#64748b;text-decoration:none;
    font-family:'Outfit',sans-serif;border:1px solid transparent;transition:all .2s;}
  ...
  .vz-live{display:flex;align-items:center;gap:5px;background:rgba(34,197,94,.08);
    border:1px solid rgba(34,197,94,.22);border-radius:20px;padding:4px 10px;
    font-size:.63rem;font-weight:800;color:#22c55e;}
  .vz-live-dot{width:6px;height:6px;border-radius:50%;background:#22c55e;
    animation:liveblink 1.2s ease-in-out infinite;}
  @keyframes liveblink{0%,100%{opacity:1;}50%{opacity:.2;}}
  .vz-user{display:flex;align-items:center;gap:7px;background:rgba(30,41,59,.7);
    border:1px solid rgba(56,189,248,.15);border-radius:10px;
    padding:4px 9px 4px 4px;text-decoration:none;transition:all .2s;}
  .vz-user:hover{border-color:rgba(56,189,248,.35);}
  .vz-avatar{width:28px;height:28px;border-radius:7px;
  ...
  .vz-logout{background:rgba(239,68,68,.07);border:1px solid rgba(239,68,68,.2);
    border-radius:8px;color:#ef4444;font-size:.72rem;font-weight:600;
  ...
  .vz-ham{display:none;background:none;border:1px solid rgba(56,189,248,.2);
    border-radius:8px;color:#94a3b8;padding:5px 9px;font-size:1.1rem;cursor:pointer;}
  @media(max-width:768px){
    .vz-links{display:none;}.vz-live{display:none;}.vz-ham{display:flex;}
    .vz-links.open{display:flex;flex-direction:column;
      position:fixed;top:62px;left:0;right:0;
      background:rgba(9,14,27,.98);border-bottom:1px solid rgba(56,189,248,.12);
      padding:.75rem 1rem;z-index:998;gap:.25rem;}
    .vz-links.open a{width:100%;padding:.65rem 1rem;}
  }
  </style>`);
  ...
  <div class="vz-nav">
    <div class="vz-nav-inner">
      ...
      <div class="vz-right">
        ...
        <button class="vz-ham" onclick="document.getElementById('vzLinks').classList.toggle('open')"><i class="bi bi-list"></i></button>
      </div>
    </div>
  </div>`);
