/**
 * VISIONZ api.js — Final Stable Version for Vercel
 * Uses relative API paths for deployment
 */

// For Vercel deployment: use relative paths (/api instead of http://localhost:8000/api)
...
const UserAPI = {
  ...
  updateProfile: (data) => apiRequest('PUT', '/users/profile', data, true),
};
